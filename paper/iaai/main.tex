...
\textbf{Continuous quality is bit-flat; the loss is the sign.} Table~\ref{tab:signloss} shows the
...
\textbf{No shallow lever beats the simple recipe.} Across eleven gates (full table in the appendix,
